...
public class fronttest5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fronttest5);
    ...
    private void showDialog(){
        ...
        final AlertDialog.Builder normalDialog =
                new AlertDialog.Builder(fronttest5.this);
