...
public class backtest4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_backtest4);
    ...
    private void showDialog(){
        ...
        final AlertDialog.Builder normalDialog =
                new AlertDialog.Builder(backtest4.this);
    ...
    public void tobacktest5(View v){
        Intent i=new Intent(backtest4.this,backtest5.class);
        startActivity(i);
    }
}
