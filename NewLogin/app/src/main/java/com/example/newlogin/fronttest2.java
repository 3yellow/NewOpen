...
public class fronttest2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fronttest2);
    ...
    private void showDialog(){
        ...
        final AlertDialog.Builder normalDialog =
                new AlertDialog.Builder(fronttest2.this);
    ...
    public void tofronttest3(View v){
        Intent i=new Intent(fronttest2.this,fronttest3.class);
        startActivity(i);
    }
}
